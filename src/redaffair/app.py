...
def log_path():
    ...
    if app is not None:
        return os.path.join(app.user_data_dir, 'redaffair_crash.log')
    return str(APP_DIR / 'redaffair_crash.log')
...
FONT_PATH = asset_path('fonts/DepartureMono.ttf')
FONT_PATH_DYSLEXIC = asset_path('fonts/OpenDyslexicAlta-Regular.otf')
...
class SFXManager:
    def __init__(self, app):
        ...
        sfx_list = [
            ('accuse', asset_path('audio/sfx/accuse.ogg'), 'Accuse'),
            ('gameover', asset_path('audio/sfx/GameOver.ogg'), 'Game Over'),
            ('fight', asset_path('audio/sfx/fight.ogg'), 'Fight'),
            ('miss', asset_path('audio/sfx/miss.ogg'), 'Miss'),
            ('miss2', asset_path('audio/sfx/miss2.ogg'), 'Miss 2'),
            ('jaildoor', asset_path('audio/sfx/jaildoor.ogg'), 'Jail Door'),
            ('lvlup', asset_path('audio/sfx/lvlup.ogg'), 'Level Up'),
            ('take', asset_path('audio/sfx/take.ogg'), 'Take Item'),
            ('cuffs', asset_path('audio/sfx/cuffs.ogg'), 'Cuffs'),
            ('hit', asset_path('audio/sfx/hit.ogg'), 'Hit'),
            ('victory', asset_path('audio/victory.ogg'), 'You Win!'),
        ]
...
class SplashScreen(Screen):
    def __init__(self, **kwargs):
        ...
        self.bg_image = Image(source=asset_path('assets/splash_bg.png'),
        ...
        self.spinner_image = Image(source=asset_path('assets/spinner.png'),
...
class SettingsScreen(Screen):
    def __init__(self, **kwargs):
        ...
        self.volume_slider = Slider(
            ...
            value_track_width=6,
            background_width=3,
            cursor_image=asset_path('assets/slider.png'),
            cursor_size=(0, 0)
        )
...
class RedAffairApp(App):
    ...
    music_tracks = [
        asset_path('audio/track1.ogg'),
        asset_path('audio/track2.ogg'),
        asset_path('audio/track3.ogg'),
        asset_path('audio/track4.ogg')
    ]
    music_info = {
        asset_path('audio/track1.ogg'): ('Blue Eyes', 'Dotdropper'),
        asset_path('audio/track2.ogg'): ('What A Shame', 'Dotdropper'),
        asset_path('audio/track3.ogg'): ('Idle Stupor', 'Dotdropper'),
        asset_path('audio/track4.ogg'): ('Track 4', 'Composer 4'),
    }
    music_index = 0
    music_volume = 0.3
    music_sound = None
    ...
    def start_ambient(self):
        try:
            self.ambient_hum = SoundLoader.load(asset_path('audio/crthum.ogg'))
            if self.ambient_hum:
        ...
        try:
            self.footstep_sound = SoundLoader.load(asset_path('audio/footsteps.ogg'))
        except Exception as e:
            log_crash(f"Footstep load error: {traceback.format_exc()}")

        try:
            self.siren_sound = SoundLoader.load(asset_path('audio/siren.ogg'))
        except Exception as e:
